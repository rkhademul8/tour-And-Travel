...
const FlightUserInfo = ({
  ...
  // adultPrice += Math.round(adultPrice * (percentRate + 0.045));
  // adultTaxPrice += Math.round(adultTaxPrice * (percentRate + 0.045));
  // childPrice += Math.round(childPrice * (percentRate + 0.045));
  // infPrice += Math.round(infPrice + infPrice * (percentRate + 0.045));
  // infTaxPrice += Math.round(infTaxPrice * (percentRate + 0.045));
