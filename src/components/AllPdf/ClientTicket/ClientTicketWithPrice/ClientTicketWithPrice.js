...
const ClientTicketWithPrice = ({ allData }) => {
  ...
  const handleToPrint = useReactToPrint({
    ...
    documentTitle: `e-Ticket_with_price_${fareCost[0]?.deptFrom}-${fareCost[0]?.arriveTo}_${fareCost[0]?.travelDate}_PAX-${fareCost[0]?.pax}`,
      ...
      {Object.keys(sabreBookData).length !== 0 ? (
        <>
          <Box className="invoice-btn">
            <button onClick={handleToPrint}>e-Ticket With Price</button>
          </Box>
                      ...
                      >
                        <Box>
                          ...
                          <h5 style={{ fontWeight: "bold" }}>
                            Coustomer Total Ticket fare Amount
                          </h5>
                        </Box>
                        <Box textAlign={"right"}>
...
export default ClientTicketWithPrice;
