...
const MultiCitySearchResult = () => {
  ...
  //   setIsLoaded(false);
  //   modifyHandleClose();
  //   let url = "https://api.flyfarint.com/v.1.0.0/AirSearch/multicity.php";
                  ...
                  >
                    <Grid className="modify-search-info" item md={8} lg={8}>
                      <Box>
                        ...
                        <h6>
                          {location.state.searchData.segments[0].depFromText.trim()}
                          <span> - </span>
                          {location.state.searchData.segments[0].arrToText.trim()}{" "}
                          ({className})
                        </h6>
                        <h5>
                          {tripType === "oneway"
